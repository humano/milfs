...
function formulario_embebido($id){
			...
			$muestra_form = "<div class='container-fluid' id='contenedor_datos' > <h1 id='titulo_modal' class='formulario_nombre'>$formulario_nombre[0]</h1>
			<h2 class='formulario_descripcion'>$formulario_descripcion[0]</h2><div id='muestra_form'>$impresion</div></div>";
			return $muestra_form ;
}
